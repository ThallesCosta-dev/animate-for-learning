...
export const Route = createFileRoute("/")({
  head: () =>
    seo({
      titulo: `${APP_NAME} — Aprenda aerodinâmica, meteorologia e segurança no parapente`,
      descricao:
...
const DESTAQUES = [
  {
    ...
    titulo: "🪂 Aerodinâmica",
    texto:
      "Veja a sustentação nascer: ângulo de ataque, estol, carga alar e vento relativo em animações interativas.",
  },
  {
    para: "/meteorologia",
  ...
  },
  {
    para: "/quiz",
    titulo: "✏️ Quiz",
    texto: "Múltipla escolha, verdadeiro ou falso e cenários, com explicação após cada resposta.",
  },
  {
    para: "/glossario",
    titulo: "📖 Glossário",
    texto: "Os termos do parapente em linguagem simples, com a explicação técnica ao lado.",
  },
] as const;
    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {LESSONS.length} aulas interativas em 3 áreas. Seu progresso fica salvo neste navegador.
        </p>
